...
const meta = {
  ...
  argTypes: {
    border: {
      control: { type: "select" },
      options: ["none", "glow", "primary", "secondary"],
...
export const BorderVariantsWithSizes: Story = {
  render: () => (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center gap-4">
        <Avatar border="primary" className="size-8">
          <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
          <AvatarFallback>SM</AvatarFallback>
        </Avatar>
        <Avatar border="primary">
        ...
        <Avatar border="primary" className="size-12">
          <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
          <AvatarFallback>LG</AvatarFallback>
        </Avatar>
        <Avatar border="primary" className="size-16">
          <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
          <AvatarFallback>XL</AvatarFallback>
        </Avatar>
      </div>
      <div className="flex items-center gap-4">
        <Avatar border="secondary" className="size-8">
          <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
          <AvatarFallback>SM</AvatarFallback>
        </Avatar>
        <Avatar border="secondary">
        ...
        <Avatar border="secondary" className="size-12">
          <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
          <AvatarFallback>LG</AvatarFallback>
        </Avatar>
        <Avatar border="secondary" className="size-16">
          <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
          <AvatarFallback>XL</AvatarFallback>
        </Avatar>
      </div>
